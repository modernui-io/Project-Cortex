...
<APITable parameters={[
  { name: "convexUrl", type: "string", required: true, description: "Your Convex deployment URL" },
  { name: "memorySpaceId", type: "string", required: true, description: "Namespace for memory isolation" },
  { name: "userId", type: "string", required: true, description: "User identifier" },
  { name: "agentId", type: "string", required: true, description: "Agent identifier (required in v0.17.0+)" },
  { name: "conversationId", type: "string", required: true, description: "Conversation identifier for chat isolation" },
  { name: "embeddingProvider", type: "object", required: true, description: "Embedding provider for semantic deduplication (required for belief revision)" },
]} />

### Optional Options

<APITable parameters={[
  { name: "userName", type: "string", required: false, description: "User display name. Default: \"User\"" },
  { name: "agentName", type: "string", required: false, description: "Agent display name. Default: agentId" },
  { name: "enableFactExtraction", type: "boolean", required: false, description: "Enable LLM fact extraction. Default: false" },
  { name: "enableGraphMemory", type: "boolean", required: false, description: "Sync to graph database. Default: false" },
  { name: "memorySearchLimit", type: "number", required: false, description: "Max memories to retrieve. Default: 20" },
  { name: "minMemoryRelevance", type: "number", required: false, description: "Min similarity score (0-1). Default: 0.7" },
