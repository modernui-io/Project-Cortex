...
<ComparisonTable
  ...
  items={[
    ...
    { feature: "Result", values: ["User repeats preferences to every tool", "Memory follows user across tools"] },
  ]}
/>
...
<ComparisonTable
  headers={["Feature", "Hive Mode", "Collaboration Mode"]}
  items={[
    ...
    { feature: "Agent Tracking", values: ["Via agentId", "Via fromAgent/toAgent"] },
...
<ComparisonTable
  headers={["Query Type", "Without Graph", "With Graph"]}
  items={[
    { feature: "1-hop lookup", values: ["3-10ms", "10-25ms"] },
    { feature: "3-hop traversal", values: ["10-50ms (limited)", "4-10ms"] },
    { feature: "7-hop traversal", values: ["Not feasible", "4-15ms"] },
    { feature: "Pattern matching", values: ["Not feasible", "10-100ms"] },
  ]}
/>
