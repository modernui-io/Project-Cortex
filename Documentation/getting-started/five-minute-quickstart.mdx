...
<ComparisonTable
  headers={["Template", "Installed", "What You Get"]}
  items={[
    { feature: "Basic Template", values: ["Always", "Interactive CLI + HTTP API server"] },
    { feature: "Vercel AI Quickstart", values: ["Optional", "Next.js ChatGPT-style web app"] },
  ]}
/>
