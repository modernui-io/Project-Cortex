...
<ComparisonTable
  headers={["Feature", "Memory Spaces", "Agent Registry"]}
  items={[
    { feature: "Purpose", values: ["Isolation boundary", "Metadata & analytics"] },
    { feature: "Status", values: ["Active, required concept", "Active, optional feature"] },
    { feature: "When to use", values: ["Define data scope", "Track agent info"] },
    { feature: "Hive Mode", values: ["Required", "Not required"] },
    { feature: "Registration", values: ["Optional", "Optional"] },
    { feature: "Analytics", values: ["Manual queries", "Auto-computed stats"] },
    { feature: "Discovery", values: ["By type/participants", "By capabilities/team"] },
    { feature: "Cascade deletion", values: ["By memorySpaceId", "By participantId"] },
  ]}
/>
...
<ComparisonTable
  headers={["Feature", "cortex.users.delete()", "cortex.agents.unregister()"]}
  items={[
    { feature: "Filter key", values: ["userId", "participantId"] },
    { feature: "Scope", values: ["Across all layers", "Across all memory spaces"] },
    { feature: "Purpose", values: ["GDPR compliance", "Convenience (cleanup)"] },
    { feature: "Required", values: ["Legal requirement", "Optional feature"] },
    { feature: "Registration", values: ["Works even if no user profile", "Works even if never registered"] },
    { feature: "Query logic", values: ["WHERE userId = X", "WHERE participantId = X"] },
    { feature: "Orphan detection", values: ["Included", "Included"] },
    { feature: "Rollback", values: ["Transaction-like", "Transaction-like"] },
  ]}
/>
