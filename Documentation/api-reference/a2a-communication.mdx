...
<ComparisonTable
  headers={["Operation", "Pub/Sub Required", "Works Without", "Why"]}
  items={[
    { feature: "send()", values: ["No", "Yes", "Fire-and-forget (async)"] },
    { feature: "request()", values: ["Yes", "No", "Needs real-time response notification"] },
    { feature: "broadcast()", values: ["Yes (optimal)", "Degraded", "Can store without pub/sub, but no delivery confirmation"] },
    { feature: "subscribe()", values: ["Yes", "No", "Real-time inbox notifications (Planned)"] },
    { feature: "getConversation()", values: ["No", "Yes", "Database query only"] },
  ]}
/>
...
<DataTable
  headers={["Field", "Constraint", "Default", "Details"]}
  rows={[
...
<ComparisonTable
  headers={["Approach", "Lines of Code", "Handles ACID", "Bidirectional / Complexity"]}
  items={[
    { feature: "cortex.a2a.send()", values: ["7", "Automatic", "Both agents / Low complexity"] },
    { feature: "cortex.memory.remember()", values: ["~20", "Automatic", "One agent (call 2x) / Medium complexity"] },
    { feature: "Manual (Layer 1+2)", values: ["50+", "Manual", "One agent (call 2x) / High complexity"] },
  ]}
/>
...
<ComparisonTable
  headers={["Operation", "A2A Helper", "Memory API Direct", "Lines of Code"]}
  items={[
    { feature: "Send message", values: ["a2a.send()", "ACID + 2x Vector stores", "7 vs 40+"] },
    { feature: "Request-response", values: ["a2a.request()", "Send + polling loop", "5 vs 35+"] },
    { feature: "Broadcast", values: ["a2a.broadcast()", "Loop + Nx2 stores", "8 vs 50+"] },
    { feature: "Get conversation", values: ["a2a.getConversation()", "Bidirectional search + merge", "6 vs 40+"] },
    { feature: "Total saved", values: ["26 lines", "165+ lines", "85% reduction"] },
  ]}
/>
