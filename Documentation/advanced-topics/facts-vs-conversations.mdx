...
<DataTable
  headers={["Query Type", "Tiers Used", "Total Tokens", "vs Raw", "Savings"]}
  rows={[
...
<DataTable
  headers={["Strategy", "Storage", "Search Context", "LLM Cost (Retrieval)", "Total Monthly"]}
  rows={[
...
<DataTable
  headers={["Strategy", "Vector Search", "Result Processing", "Total Latency"]}
  rows={[
...
<DataTable
  headers={["Strategy", "Vector Search", "Fetch ACID", "Total"]}
  rows={[
...
<DataTable
  headers={["Query Type", "Raw", "Facts", "Improvement"]}
  rows={[
...
<ComparisonTable
  headers={["Information Type", "Raw", "Facts", "Hybrid"]}
  items={[
    { feature: "Core facts", values: ["Yes", "Yes", "Yes"] },
    { feature: "Exact wording", values: ["Yes", "No", "Yes (in ACID)"] },
    { feature: "Tone/sentiment", values: ["Yes", "No", "Yes (in ACID)"] },
    { feature: "Timestamps", values: ["Yes", "Yes", "Yes"] },
    { feature: "Context flow", values: ["Yes", "Partial", "Yes (in ACID)"] },
    { feature: "Meta-conversation", values: ["Yes", "No", "Yes (in ACID)"] },
  ]}
/>
...
<DataTable
  headers={["Strategy", "Precision", "Recall", "F1 Score", "Avg Latency"]}
  rows={[
...
<ComparisonTable
  headers={["Criteria", "Raw", "Facts", "Hybrid"]}
  items={[
    { feature: "Storage Cost", values: ["High ($0.50/GB)", "Low ($0.05/GB)", "Medium ($0.09/GB)"] },
    { feature: "Token Cost", values: ["High ($400/mo)", "Low ($8/mo)", "Low ($8/mo)"] },
    { feature: "Extraction Cost", values: ["$0", "$10/mo", "$10/mo"] },
    { feature: "Search Speed", values: ["Slow (130ms)", "Fast (40ms)", "Fast (40ms)"] },
    { feature: "Precision", values: ["Medium (72%)", "High (89%)", "High (89%)"] },
    { feature: "Recall", values: ["High (85%)", "Medium (78%)", "High (85%)"] },
    { feature: "Compliance", values: ["Perfect", "Not verbatim", "Perfect"] },
    { feature: "Exact Quotes", values: ["Always", "Never", "On demand"] },
    { feature: "Setup Complexity", values: ["Low", "Medium", "Medium"] },
    { feature: "Best For", values: ["Compliance", "Efficiency", "Production"] },
    { feature: "Recommendation", values: ["Good", "Better", "Best"] },
  ]}
/>
