...
<DataTable
  headers={["Hops", "Query Type", "Avg Latency", "Complexity", "Use Case"]}
  rows={[
...
<ComparisonTable
  headers={["Your Need", "Graph-Lite", "Native Graph DB"]}
  items={[
    { feature: "Context hierarchies (depth <5)", values: ["Perfect", "Overkill"] },
    { feature: "Audit trails (known paths)", values: ["Perfect", "Overkill"] },
    { feature: "Agent collaboration (1-3 hops)", values: ["Good", "Better"] },
    { feature: "Deep traversals (6+ hops)", values: ["Too slow", "Required"] },
    { feature: "Pattern matching", values: ["Very hard", "Required"] },
    { feature: "Graph algorithms", values: ["Not feasible", "Required"] },
    { feature: "Dense relationship networks", values: ["Slow", "Best"] },
  ]}
/>
...
<DataTable
  headers={["Database", "Setup Difficulty", "Performance", "Cost", "Best For"]}
  rows={[
...
<ComparisonTable
  headers={["Feature", "Graph-Lite (Built-in)", "Native Graph DB"]}
  items={[
    { feature: "Setup", values: ["None (included)", "Docker or managed service"] },
    { feature: "Storage", values: ["Convex only", "Convex + Graph DB"] },
    { feature: "Consistency", values: ["Always consistent", "Eventually consistent"] },
    { feature: "Query Speed", values: ["50-500ms (depth-dependent)", "10-100ms (constant)"] },
    { feature: "Max Depth", values: ["5 hops practical", "100+ hops"] },
    { feature: "Algorithms", values: ["Manual implementation", "Built-in"] },
    { feature: "Cost", values: ["Free (Convex storage)", "Graph DB cost + sync"] },
    { feature: "Complexity", values: ["Low (no extra systems)", "Medium (2 databases)"] },
    { feature: "Use Cases", values: ["90% of use cases", "Advanced/enterprise"] },
  ]}
/>
