...
<DataTable
  headers={["Strategy", "How it Works", "Speed", "Accuracy"]}
  rows={[
...
<DataTable
  headers={["Model", "Facts", "Entities", "Relations", "Avg Latency"]}
  rows={[
    { values: ["gpt-4o-2024-11-20", "13", "15", "6", "11.6s"], highlight: "best" },
    { values: ["gpt-5-mini", "13", "23", "17", "56.9s"], highlight: "recommended" },
    { values: ["gpt-5.1", "12", "15", "13", "18.6s"] },
    { values: ["gpt-5.2", "12", "18", "14", "20.3s"] },
    { values: ["gpt-5-mini-2025-08-07", "12", "26", "19", "50.1s"] },
    { values: ["gpt-5-nano", "12", "22", "14", "100.5s"] },
    { values: ["gpt-4o", "11", "10", "1", "13.0s"], highlight: "fastest" },
    { values: ["gpt-4o-mini-2024-07-18", "11", "13", "0", "15.8s"] },
    { values: ["gpt-4o-mini", "11", "15", "0", "16.0s"] },
    { values: ["gpt-5", "9", "18", "11", "82.7s"] },
  ]}
  numericColumns={[1, 2, 3]}
  caption="OpenAI model comparison for fact extraction (January 2026)"
/>
...
<FeatureGrid>
  <FeatureCard
    icon="speed"
    title="Best Balance"
    description="gpt-4o-2024-11-20 offers top-tier quality (13 facts) with fastest latency (11.6s)"
    size="large"
  />
  <FeatureCard
    icon="brain"
    title="Best Quality"
    description="gpt-5-mini extracts more entities/relations but at 5x latency cost"
    size="large"
  />
  <FeatureCard
    icon="fast"
    title="Budget Option"
    description="gpt-4o-mini provides good extraction at lower cost, but extracts fewer relations"
    size="medium"
  />
  <FeatureCard
    icon="chart"
    title="Production Tip"
    description="Use faster models for high-volume workloads; premium models for complex extraction"
    size="medium"
  />
  <FeatureCard
    icon="scale"
    title="GPT-5 Series"
    description="gpt-5.1 and gpt-5.2 offer good balance between quality and speed for mid-tier workloads"
    size="medium"
  />
</FeatureGrid>
