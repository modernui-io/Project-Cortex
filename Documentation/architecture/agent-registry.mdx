...
<ComparisonTable
  ...
  items={[
    { feature: "Purpose", values: ["Define isolation boundaries", "Track agent metadata"] },
    { feature: "Status", values: ["Active, required concept", "Active, optional feature"] },
    { feature: "Use Case", values: ["Scope for data (conversations, memories, facts)", "Analytics, discovery, team organization"] },
    { feature: "Registration", values: ["Optional", "Optional"] },
    { feature: "Enables", values: ["Hive Mode, Collaboration Mode", "Agent discovery, statistics, cascade deletion"] },
    { feature: "Supports", values: ["Multi-participant spaces", "Single agent tracking"] },
    { feature: "Query by", values: ["memorySpaceId", "agentId, capabilities, team"] },
    { feature: "Cascade delete", values: ["All data in space", "All data by participantId across spaces"] },
  ]}
/>
