...
<ComparisonTable
  headers={["Approach", "Tokens per Request", "Cost per Request", "Scalability"]}
  items={[
    { feature: "Traditional (Accumulation)", values: ["50,000 tokens", "$1.50 (GPT-5-nano)", "Hits limits at ~2K exchanges"] },
    { feature: "Summarization", values: ["10,000 tokens", "$0.30", "Loses nuance, still expensive"] },
    { feature: "Infinite Context (Facts)", values: ["80 tokens", "$0.0024", "Scales to 1M+ exchanges"] },
    { feature: "Infinite Context (Hybrid)", values: ["405 tokens", "$0.012", "Scales + full fidelity"] },
  ]}
/>
...
<ComparisonTable
  headers={["Model", "Context Window", "Cost per 1M Tokens", "With Infinite Context"]}
  items={[
    { feature: "gpt-5-nano (legacy)", values: ["16K", "$0.50", "Effectively unlimited (via retrieval)"] },
    { feature: "GPT-5", values: ["1M", "$5", "Retrieval still better (cheaper + faster)"] },
    { feature: "Claude-4.5-sonnet", values: ["200K", "$3", "Retrieval is faster than large context"] },
    { feature: "o3-mini", values: ["128K", "$2", "Can use smaller models effectively"] },
  ]}
/>
...
<ComparisonTable
  headers={["Capability", "Cortex", "Traditional LLM Apps"]}
  items={[
    { feature: "Context Limit", values: ["Infinite", "16K-200K"] },
    { feature: "Token Efficiency", values: ["99% reduction", "Baseline (accumulation)"] },
    { feature: "Retrieval Speed", values: ["<50ms", "N/A (no retrieval)"] },
    { feature: "Cost at Scale", values: ["Constant", "Grows linearly"] },
    { feature: "Works with Any Model", values: ["Yes (small models perform like SOTA)", "Limited by window"] },
    { feature: "History Length", values: ["Unlimited", "Limited by context window"] },
  ]}
/>
