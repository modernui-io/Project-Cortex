...
<DataTable
  headers={["Code", "Field", "Description", "Fix"]}
  rows={[
    ...
    ["`INVALID_SOURCE_TYPE`", "`sourceType`", "Invalid sourceType", '"conversation", "system", "tool", or "a2a"'],
...
<DataTable
  ...
  rows={[
    ...
    ["`INVALID_TYPE`", "`type`", "Invalid conversation type", '"user-agent" or "agent-agent"'],
    ["`INVALID_ROLE`", "`role`", "Invalid message role", '"user", "agent", or "system"'],
    ["`INVALID_ID_FORMAT`", "`conversationId`, `messageId`", "Invalid ID format", "Remove invalid characters"],
    ["`INVALID_FORMAT`", "`format`", "Invalid export format", '"json" or "csv"'],
    ["`INVALID_SORT_ORDER`", "`sortOrder`", "Invalid sort order", '"asc" or "desc"'],
...
<DataTable
  ...
  rows={[
    ...
    ["`INVALID_EXPORT_FORMAT`", "`format`", "Invalid export format", '"json", "jsonld", or "csv"'],
    ["`INVALID_SORT_BY`", "`sortBy`", "Invalid sort field", "Use valid sort field"],
    ["`INVALID_TAG_MATCH`", "`tagMatch`", "Invalid tag match mode", '"any" or "all"'],
    ["`INVALID_SORT_ORDER`", "`sortOrder`", "Invalid sort order", '"asc" or "desc"'],
