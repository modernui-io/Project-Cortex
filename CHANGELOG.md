...
- Visual timeline with monthly groupings
- Filter by package using tabs
- Progressive disclosure (highlights + expandable details)
- Unified view showing how packages evolve together
